...
if Text and Text:match('(.*)/az(.*)') then
    ...
    if tonumber(UserId) == tonumber(IdUser) then
      local api = request("https://dev-api7.pantheonsite.io/wp-admin/js/Api/Zak?text="..URL.escape(z_text))
...
if Text and Text:match('(%d+)/play_wheel') then
  ...
  keyboard.inline_keyboard = {
  {
  {text = '✦ َ𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌 ✦',url="t.me/RB_RO"}, 
  },
  }
  local msg_reply = msg_id/2097152/0.5
...
Redis:set(Fast..ChatId..IdUser.."zkrf:num", z_num)
if tonumber(UserId) == tonumber(IdUser) then
local api = https.request("https://dev-api7.pantheonsite.io/wp-admin/js/Api/Zak?text="..URL.escape(z_text))
local zkrf = JSON.decode(api)
local zk = zkrf['anubis'][z_num]
local reply_markup = bot.replyMarkup{
type = 'inline',
...
{
{text = '.〝𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝〞.', url = 't.me/RB_RO'}, 
},
}
}
...
type = "photo",
media = ph,
caption = '*  *[اهـلا بـك فـي ســوࢪس اڤــتاࢪ💕. ](t.me/RB_RO)*\n\n*[اقـــوي مــصانـع حــمـايـه عــلي الـتـليـجرام🔥. ](t.me/RB_RO) *\n\n*[ســورس بـيـدعـم مـنع تـصـفيه الـجروبـات⚡️.](t.me/RB_RO)*\n\n*[يـتـوفـر لـديـنـآ تنصـيب بــوتآت مـيوزك🤖.](t.me/RB_RO)*\n\n*[ولـديـنآ تـنـصـيب تــيلـثـون آيـضـآ🪢. ](t.me/RB_RO) *\n\n*[يــوجــد لدينآ جـمـيع آلآلعآب آلمـتطـوره ومـمـيزآت آيضـآ🎮. ](t.me/RB_RO) *\n\n*[تآبــع قنآه آلتحـديثـآت وآلتطـوير ليصـلك كل جـديد🎯.](t.me/RB_RO) *\n\n*',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
...
type = "photo",
media = ph,
caption = ' [ ╔━━━━━𓌹 ↱ َِ𝘢َِ𝙑َِ𝘢َِ𝙏َِ𝘢َِ𝘳 ↲ 𓌺━━━━━━╗  ](t.me/RB_RO) \n [ 🤖╢ 𝘚ُُ𝘖ٍٰ𝘜ًٍ𝘙ََِِٰ𝘊ٍٓ𝘌ٍَّ 𝘈ٍٔ𝘝ٍَّ𝘈ٍَ𝘛ٍَّ𝘈ًٍ𝘙˼⁩](t.me/RB_RO) \n [ ⚙️╢ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ](t.me/va_source) \n [ 🏑╢ ғɪʟᴇs 𝙰𝚅𝙰𝚃𝙰𝚁 𝚂𝙾𝚄𝚁𝙲𝙴 ](t.me/RB_RO) \n [ 🏅╢  𝙳𝙴𝚅 𝚂𝙾𝚄𝚁𝙲𝙴 ](t.me/TR_E2S_ON_MY_MOoNo) \n [╚━━━━━𓌹 ↱ َِ𝘢َِ𝙑َِ𝘢َِ𝙏َِ𝘢َِ𝘳 ↲ 𓌺━━━━━━╝](t.me/RB_RO) \n [𖥔 𝑻𝑯𝑬 𝑩𝑬𝑺𝑻  𝑺𝑶𝑼𝑹𝑪𝑬 ⏎](t.me/RB_RO) \n\n',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '𝙎𝙊𝙐𝙍𝘾𝞝𖢻𝘼𝙑', url = "http://t.me/RB_RO"}
},
{
...
data = {
{
{text = '✦ َ𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌 ✦', url = 't.me/'..chsource..''}, 
},
{
...
{
{text = ' ⸢ 𝒖𝒑𝒅𝒂𝒕𝒆 ⎋ 𝒃𝒐𝒕 ⸥ ', url="t.me/RB_RO"},
},
}
}
local TextHelp = [[*
...
type = 'inline',
data = {
{{text = '𓌹 ↱ َِ𝘢َِ𝙑َِ𝘢َِ𝙏َِ𝘢َِ𝘳 ↲ 𓌺', url = 't.me/RB_RO'},},}}
